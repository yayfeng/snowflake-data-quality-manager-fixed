...
-- 
-- IMPORTANT: Before creating the Streamlit app, please update the warehouse name below
-- from COMPUTE_WH to your actual warehouse name (e.g., your_warehouse_name)
-- 
-- Also make sure to upload all Python files to the DATA_QUALITY.CONFIG.CODE stage:
